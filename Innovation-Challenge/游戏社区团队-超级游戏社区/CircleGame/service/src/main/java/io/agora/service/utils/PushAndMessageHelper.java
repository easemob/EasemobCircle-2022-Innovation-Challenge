...
public class PushAndMessageHelper {
        ...
        switch (type) {
            ...
            case IMAGE:
                ...
                if(uri != null) {
                    ...
                    LiveEventBus.get(Constants.MESSAGE_FORWARD)
                            .post(new EaseEvent("No image resource", EaseEvent.TYPE.MESSAGE));
                }
                break;
        }
    }
    ...
    public static String getSystemMessage(EMMessage msg)  throws HyphenateException {
        String messageStatus = msg.getStringAttribute(Constants.SYSTEM_MESSAGE_STATUS);
        ...
        switch (status) {
            ...
            case AGREED:
            case BEREFUSED:
                messge = String.format(builder.toString(), msg.getStringAttribute(Constants.SYSTEM_MESSAGE_FROM));
                break;
            case BEAGREED:
            ...
            case GROUPINVITATION:
                String name = msg.getStringAttribute(Constants.SYSTEM_MESSAGE_NAME);
                messge = String.format(builder.toString(), msg.getStringAttribute(Constants.SYSTEM_MESSAGE_FROM), name);
                break;
            ...
            case MULTI_DEVICE_GROUP_REMOVE_MUTE:
                messge = String.format(builder.toString(), msg.getStringAttribute(Constants.SYSTEM_MESSAGE_INVITER));
                break;
    ...
    public static String getSystemMessage(Map<String, Object> msg)  throws NullPointerException {
        String messageStatus = (String) msg.get(Constants.SYSTEM_MESSAGE_STATUS);
        if(TextUtils.isEmpty(messageStatus)) {
            return "";
        }
        InviteMessageStatus status = InviteMessageStatus.valueOf(messageStatus);
        ...
        switch (status) {
            ...
            case AGREED:
            case BEREFUSED:
                messge = String.format(builder.toString(), msg.get(Constants.SYSTEM_MESSAGE_FROM));
                break;
            case BEAGREED:
            case MULTI_DEVICE_GROUP_LEAVE:
                messge = builder.toString();
                break;
            case BEAPPLYED:
                messge = String.format(builder.toString(), msg.get(Constants.SYSTEM_MESSAGE_FROM), (String) msg.get(Constants.SYSTEM_MESSAGE_NAME));
                break;
            case GROUPINVITATION:
                messge = String.format(builder.toString(), msg.get(Constants.SYSTEM_MESSAGE_INVITER), (String) msg.get(Constants.SYSTEM_MESSAGE_NAME));
                break;
            case GROUPINVITATION_ACCEPTED:
            case GROUPINVITATION_DECLINED:
            case MULTI_DEVICE_GROUP_APPLY_ACCEPT:
            ...
            case MULTI_DEVICE_GROUP_ADD_MUTE:
            case MULTI_DEVICE_GROUP_REMOVE_MUTE:
                messge = String.format(builder.toString(), msg.get(Constants.SYSTEM_MESSAGE_INVITER));
                break;
            case MULTI_DEVICE_CONTACT_ADD:
            case MULTI_DEVICE_CONTACT_BAN:
            case MULTI_DEVICE_CONTACT_ALLOW:
    ...
    private static void sendBigExpressionMessage(String toChatUsername, String name, String identityCode){
        EMMessage message = CircleUtils.createExpressionMessage(toChatUsername, name, identityCode);
        sendMessage(message);
    }
    ...
    private static void sendMessage(EMMessage message) {
        message.setMessageStatusCallback(new EMCallBack() {
            ...
            public void onSuccess() {
                LiveEventBus.get(Constants.MESSAGE_FORWARD)
                        .post(new EaseEvent(BaseApplication.getContext().getString(R.string.has_been_send), EaseEvent.TYPE.MESSAGE));
            }
