package io.agora.chat.viewholder;
...
public class CircleInviteViewHolder extends EaseChatRowViewHolder {

    public CircleInviteViewHolder(@NonNull View itemView, MessageListItemClickListener itemClickListener) {
    ...
    public static EaseChatRowViewHolder create(ViewGroup parent,
        ...
        return new CircleInviteViewHolder(new EaseChatRowText(parent.getContext(), isSender), itemClickListener);
    }
