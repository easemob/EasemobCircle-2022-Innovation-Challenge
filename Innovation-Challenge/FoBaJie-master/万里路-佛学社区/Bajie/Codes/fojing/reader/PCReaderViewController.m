...
//    UIBarButtonItem *item5 = [[UIBarButtonItem alloc] initWithTitle:@"目录" style:UIBarButtonItemStylePlain target:self action:@selector(catalogAction)];
    ...
    [self.toolbar setItems:@[item2,fixibleItem,item3]];
...
- (UIButton *)plusButton
{
    if (!_plusButton) {
        ...
        _plusButton.backgroundColor = [UIColor colorWithRed:209.0/255.0 green:170.0/255.0 blue:75.0/255.0 alpha:1];;
...
- (UIButton *)minusButton
{
    if (!_minusButton) {
        ...
        _minusButton.backgroundColor = [UIColor colorWithRed:209.0/255.0 green:170.0/255.0 blue:75.0/255.0 alpha:1];;
