...
import { MESSAGE_ITEM_SOURCE,MemberLevel } from "@/consts";
        ...
        <div className={s.messageInfo}>
          <div className={s.bar}>
            <div className={s.l}>
              ...
              <span className={s.date}>{message.grade}</span>
          ...
          <div className={s.content}>
            {message.type === "txt" && <TxtMsg message={message} self={false}/>}
            {message.type === "img" && <ImgMsg message={message} self={false}/>}
            {message.type === "file" && <FileMsg message={message} self={false}/>}
            {message.type === "recall" && <RecallMsg message={message} self={false}/>}
            {message.type === "custom" && <CustomMsg message={message} self={false}/>}
          </div>
        </div>
      </div>
      {showReactionInfo && (
