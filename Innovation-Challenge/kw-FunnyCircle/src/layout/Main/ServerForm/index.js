...
const ServerForm = forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      ...
      {/* <Form.Item label={isEdit ? "社区类别" : ""} name="type">

        <Select name="type" defaultValue="video" onChange={()=>{

        }}>
          <Select.Option value="video">视频</Select.Option>
          <Select.Option value="audio">音乐</Select.Option>
          <Select.Option value="read">读书</Select.Option>
        </Select>
      </Form.Item> */}
