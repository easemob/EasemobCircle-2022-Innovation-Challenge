...
public class CircleFileViewHolder extends EaseChatRowViewHolder {

    public CircleFileViewHolder(@NonNull View itemView, MessageListItemClickListener itemClickListener) {
    ...
    public static EaseChatRowViewHolder create(ViewGroup parent,
        ...
        return new CircleFileViewHolder(new EaseChatRowFile(parent.getContext(), isSender), itemClickListener);
    }
