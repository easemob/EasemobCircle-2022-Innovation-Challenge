...
class MainViewController: UITabBarController {
    ...
    private func createMessageViewController() -> UIViewController {
        ...
        let tabbar = UITabBarItem(title: nil, image: UIImage(named: "tab_item_message"), selectedImage: UIImage(named: "tab_item_message_selected"))
    ...
    private func createSquareViewController() -> UIViewController {
        ...
        let navVc = NavigationController(rootViewController: vc)
        let tabbar = UITabBarItem(title: nil, image: UIImage(named: "tab_item_square"), selectedImage: UIImage(named: "tab_item_square_selected"))
        navVc.tabBarItem = tabbar
        return navVc
    }
    ...
    private func createContactsViewController() -> UIViewController {
        ...
        let navVc = NavigationController(rootViewController: vc)
        let tabbar = UITabBarItem(title: nil, image: UIImage(named: "tab_item_contacts"), selectedImage: UIImage(named: "tab_item_contacts_selected"))
        navVc.tabBarItem = tabbar
        return navVc
    }
    ...
    private func createMeViewController() -> UIViewController {
        ...
        let navVc = NavigationController(rootViewController: vc)
        let tabbar = UITabBarItem(title: nil, image: UIImage(named: "tab_item_me"), selectedImage: UIImage(named: "tab_item_me_selected"))
        navVc.tabBarItem = tabbar
        return navVc
    }
