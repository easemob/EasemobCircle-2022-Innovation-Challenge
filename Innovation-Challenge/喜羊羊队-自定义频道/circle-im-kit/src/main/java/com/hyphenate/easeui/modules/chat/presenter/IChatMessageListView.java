...
public interface IChatMessageListView extends ILoadDataView {
     ...
     * @param data
     */
    void loadServerMsgSuccess(List<EMMessage> data, String cursor);

    /**
     * 加载更多漫游数据
     * @param data
     */
    void loadMoreServerMsgSuccess(List<EMMessage> data, String cursor);
     ...
     * @param message
     */
    void insertMessageToLast(EMMessage message);
