          ...
          <div className={s.iptWrap}>
            {quote ? (
                <div className={s.quote}>
                  <div className={s.quoteTxt}>
                    <span className={s.d}>"</span>
                    <span>{quote.from}</span>: <span>{quote.msg}</span>
                  </div>
                  <Icon color="gray" iconClass="icon-xmark_in_circle" name="icon-xmark_in_circle" onClick={() => setQuote(null)} />
                </div>
            ): ("")}
            <Input chatType={CHAT_TYPE.groupChat} quote={quote} quoteHandler={() => setQuote(null)} fromId={channelId} />
          </div>
        </div>
      </div>
      <MemberModal />
