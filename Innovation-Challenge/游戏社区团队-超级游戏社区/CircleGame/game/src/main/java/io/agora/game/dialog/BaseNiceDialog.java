...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    private static final String END = "show_end";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            showEnd = savedInstanceState.getBoolean(END);
    ...
    public void onResume() {
        ...
        if (showEnd){
            ...
            lp.gravity = Gravity.END; //设置dialog的位置在底部
            lp.windowAnimations = R.style.EndAnimation; //设置右侧动画
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(END, showEnd);
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = DisplayUtil.getHeight(getContext()) - 2 * DisplayUtil.dp2px(getContext(), margin);
            } else if (width == -1) {
...
//        setCancelable(outCancel); //hw修改
    ...
    public BaseNiceDialog setShowEnd(boolean showEnd) {
