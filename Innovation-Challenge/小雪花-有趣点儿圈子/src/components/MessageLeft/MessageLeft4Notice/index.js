...
const MessageLeft4Notice = (props) => {
  const parent = useRef();
      ...
      <div className={s.message}>
        ...
        <div className={s.messageInfo}>
            ...
            <div className={s.l}>
              <span className={s.name}>
                {appUserInfo[message.from]?.nickname || message.from}
                  ...
                  <Tag color="red">{message.ext?.rankValue}</Tag>

              <Tag icon={<CrownOutlined />} color="#55acee"></Tag>
          ...
          <div className={s.content}>
            ...
            {message.type === "custom" && message.customExts?.type === null && <CustomMsg message={message} />}
...
export default memo(connect(mapStateToProps, null)(MessageLeft4Notice));
