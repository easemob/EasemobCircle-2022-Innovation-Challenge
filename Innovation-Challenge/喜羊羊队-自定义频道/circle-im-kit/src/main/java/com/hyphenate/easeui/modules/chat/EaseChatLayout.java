...
import com.hyphenate.easeui.modules.menu.EaseReactionMenuHelper;
...
public class EaseChatLayout extends RelativeLayout implements IChatLayout, IHandleMessageView, IPopupWindow
        ...
        , MessageListItemClickListener, EaseChatMessageListLayout.OnChatErrorListener, View.OnClickListener {
    ...
    public void init(EaseChatMessageListLayout.LoadDataType loadDataType, String conversationId, int chatType) {
        ...
        presenter.setupWithToUser(chatType, this.conversationId, loadDataType == EaseChatMessageListLayout.LoadDataType.THREAD, isChannel);
...
//        }
    ...
    public void sendCustomMessage(String code) {
        presenter.sendCustomMessage(code);
    }
    ...
    @Override
    public void recallMessageFinish(EMMessage message, EMMessage notification) {
        if (recallMessageListener != null) {
            recallMessageListener.recallSuccess(message, notification);
        }
...
//        inputMenu.setBackgroundResource(R.drawable.ease_chat_input_bg);
    ...
    public boolean onThreadClick(String messageId, String threadId, String parentId) {
        if(listener != null) {
            return listener.onThreadClick(messageId, threadId,parentId);
        }
        return false;
    }
    ...
    public boolean onThreadLongClick(View v, String messageId, String threadId, String parentId) {
        if(listener != null) {
            return listener.onThreadLongClick(v, messageId, threadId,parentId);
        }
        return false;
    }
            ...
            public boolean onMenuItemClick(MenuItemBean item) {
                ...
                if (showDefaultMenu) {
                    ...
                    if (itemId == R.id.action_chat_copy) {
                        ...
                        Toast.makeText(getContext(), getContext().getString(R.string.ease_copied_to_the_clipboard), Toast.LENGTH_SHORT).show();
    ...
    private View checkHeaderViewForDefaultMenu(EMMessage message) {
    ...
    public void setIsChannel(boolean isChannel) {
        ...
        presenter.setIsChannel(isChannel);
        messageListLayout.setIsChannel(isChannel);
    }
    ...
    public void onReactionChanged(List<EMMessageReactionChange> list) {
        ...
        for (EMMessageReactionChange reactionChange : list) {
