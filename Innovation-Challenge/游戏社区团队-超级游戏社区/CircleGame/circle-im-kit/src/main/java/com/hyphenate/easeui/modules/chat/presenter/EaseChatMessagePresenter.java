...
public abstract class EaseChatMessagePresenter extends EaseBasePresenter {
     ...
     * @param pageSize
     */
    public abstract void loadServerMessages(int pageSize, EMConversation.EMSearchDirection direction);
    /**
     * 从服务器加载更多数据
     * @param msgId 消息id
     * @param pageSize
     ...
     * @param pageSize
     */
    public abstract void loadMoreServerMessages(String msgId, int pageSize, EMConversation.EMSearchDirection direction);
