...
public abstract class EaseHandleMessagePresenter extends EaseBasePresenter {
     ...
     * @param isChannel
     */
    public void setupWithToUser(int chatType, @NonNull String toChatUsername, boolean isThread,boolean isChannel) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        this.isThread = isThread;
        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true,isThread,isChannel);
    }
    ...
    public abstract void sendCustomMessage(String code);
    /**
     * 发送图片消息
     * @param imageUri
