...
@property (nonatomic, assign) Boolean isEnable;
...
- (void)show
{
	...
	[UIView animateWithDuration:animationDuration
									 ...
									 animations:^{
										 ...
										 NSInteger count = MAX(4, self.listArray.count);
...
{
	self.contentLabel.text = atext;
}

- (void)setEnabled:(Boolean)aIsEnable {
	self.isEnable = aIsEnable;
	self.arrowImgView.hidden = !aIsEnable;
}
