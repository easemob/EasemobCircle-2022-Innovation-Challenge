...
export default function initListener() {
  ...
  WebIM.conn.addEventHandler("messageEvent", {
    onTextMessage: (message) => {
      console.log("onTextMessage %o",message);
    ...
    onReactionChange: ({ messageId, reactions }) => {
      try {
        console.log("onReactionChange %o",messageId);
        console.log("onReactionChange %o",reactions);
    ...
    onImageMessage: (message) => {
      console.log("onImageMessage %o",message);
      if (message.chatThread) {
        dispatch.thread.setThreadMessage({
          message,
    ...
    onFileMessage: (message) => {
      console.log("onFileMessage %o",message);
      if (message.chatThread) {
        dispatch.thread.setThreadMessage({
          message,
          fromId: getMessageFromId(message)
    ...
    onRecallMessage: (message) => {
      console.log("onRecallMessage %o",message);
    ...
    onCustomMessage: (message) => {
      console.log("onCustomMessage %o",message);
      dispatch.app.insertChatMessage({
        chatType: message.chatType,
        fromId: getMessageFromId(message),
        messageInfo: {
