...
public class CircleImageViewHolder extends EaseChatRowViewHolder {

    public CircleImageViewHolder(@NonNull View itemView, MessageListItemClickListener itemClickListener) {
    ...
    public static EaseChatRowViewHolder create(ViewGroup parent,
        ...
        return new CircleImageViewHolder(new EaseChatRowImage(parent.getContext(), isSender), itemClickListener);
    }
