...
public class ChatFragment extends EaseChatFragment implements OnRecallMessageResultListener {
    ...
    public ChatFragment(String type) {
        mType = type;
    }
...
//        chatLayout.getChatInputMenu().getEmojiconMenu().addEmojiconGroup(EmojiconExampleGroupData.getData());
    ...
    public void setChannelType() {
        chatLayout.getChatInputMenu().setVisibility(TextUtils.equals(mType, "video") ? View.GONE : View.VISIBLE);
        chatLayout.getBtnVideo().setVisibility(TextUtils.equals(mType, "video") ? View.VISIBLE : View.GONE);
    }
