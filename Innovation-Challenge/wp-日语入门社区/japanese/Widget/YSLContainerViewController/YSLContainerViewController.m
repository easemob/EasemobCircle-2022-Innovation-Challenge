...
//  Copyright (c) 2020年 h.LYQ. All rights reserved.
//
...
- (void)viewDidLoad {
    ...
    _menuView.itemTitleColor = UIColor.grayColor;
    _menuView.itemIndicatorColor = UIColor.systemGreenColor;
...
- (void)scrollMenuViewSelectedIndex:(NSInteger)index
{
    ...
    // item color
    [_menuView setItemTextColor:UIColor.grayColor
           seletedItemTextColor:UIColor.systemGreenColor
                   currentIndex:index];
