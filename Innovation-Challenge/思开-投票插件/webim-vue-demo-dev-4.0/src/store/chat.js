...
const Chat = {
  ...
  actions: {
    ...
    onSendText: function (context, payload) {
      const {chatType, chatId, message, vote} = payload;
      ...
      msgObj.set({
        ...
        success: function () {
          ...
          context.commit('updateMsgList', vo);
        },
        fail: function (e) {
          ...
          try {
            ...
            if (msgs.length) {
              ...
              msgs.forEach((item) => {
                ...
                if (item.ext && item.ext.vote) {
                  msg.vote = item.ext.vote;
                }
                msg.isHistory = true;
