      ...
      <div className={s.message}>
        ...
        <div className={s.messageInfo}>
          ...
          <div className={s.content}>
            {message.type === "txt" && <TxtMsg message={message} self={true}/>}
            {message.type === "img" && <ImgMsg message={message}  self={true}/>}
            {message.type === "file" && <FileMsg message={message}  self={true}/>}
            {message.type === "recall" && <RecallMsg message={message}  self={true}/>}
            {message.type === "custom" && <CustomMsg message={message}  self={true}/>}
          </div>
        </div>
      </div>
      {showReactionInfo && (
