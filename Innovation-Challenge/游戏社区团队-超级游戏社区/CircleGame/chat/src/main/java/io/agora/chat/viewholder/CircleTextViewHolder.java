...
public class CircleTextViewHolder extends EaseChatRowViewHolder {

    public CircleTextViewHolder(@NonNull View itemView, MessageListItemClickListener itemClickListener) {
    ...
    public static EaseChatRowViewHolder create(ViewGroup parent,
        ...
        return new CircleTextViewHolder(new EaseChatRowText(parent.getContext(), isSender), itemClickListener);
    }
